...
export type UserRole = 'admin' | 'manager' | 'waiter' | 'user';
...
export type OnlineOrderStatus = 'payment_pending' | 'confirmed' | 'preparing' | 'out_for_delivery' | 'delivered' | 'cancelled';
...
export interface Order {
  id: string;
  tableNumber?: number; // Optional for pickup orders
  orderType: OrderType;
  items: OrderItem[];
  status: OrderStatus;
  waiterId: string;
