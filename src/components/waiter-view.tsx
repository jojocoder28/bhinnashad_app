...
export default function WaiterView({ orders, bills, menuItems, waiters, tables, onUpdateStatus, onCreateOrder, onUpdateOrder, onDeleteOrder, onOpenOrderForm, currentUser }: WaiterViewProps) {
        ...
        actions.push(
            <DropdownMenu key="actions-menu">
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={() => onOpenOrderForm(order)}>
  ...
  return (
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <Button className="w-full sm:w-auto" onClick={() => onOpenOrderForm(null)} disabled={!selectedWaiter.id}>
